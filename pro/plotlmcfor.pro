pro plotlmcfor,file,dfile,over=over,twoplot=twoplot,save=save
...
if keyword_set(save) then ps_open,'plotlmcfor',/color
...
plot,dist(5),/nodata,xtit='XGC',ytit='ZGC',xr=[-200,200],yr=[-200,200],xs=1,ys=1
...
psym8,sym8a,/fill,/square
plot,dist(5),/nodata,xtit='t',ytit='RGC',xr=[tmin,0],yr=[0,250],xs=1,ys=1
...
!p.multi=[2,2,2]
psym8,sym8a,/fill,/square
plot,dist(5),/nodata,xtit='XGC',ytit='YGC',xr=[-200,200],yr=[-200,200],xs=1,ys=1
oplot,[0],[0],ps=1       ;origin
...
plot,dist(5),/nodata,xtit='YGC',ytit='ZGC',xr=[-200,200],yr=[-200,200],xs=1,ys=1
oplot,[0],[0],ps=1       ;origin

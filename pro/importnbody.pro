...
8: begin
  array[*,*,5] = array[*,*,5]*kpcGyr2kms
  array[*,*,6] = array[*,*,6]*kpcGyr2kms
  array[*,*,7] = array[*,*,7]*kpcGyr2kms
end
; time, mass, soft, x, y, z, vx, vy, vz
9: begin
  array[*,*,6] = array[*,*,6]*kpcGyr2kms
  array[*,*,7] = array[*,*,7]*kpcGyr2kms
  array[*,*,8] = array[*,*,8]*kpcGyr2kms
end
else: stop,'Do not understand this format'
endcase

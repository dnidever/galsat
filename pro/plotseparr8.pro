pro plotseparr8,file,psave=psave,color=color,post=post,$
...
if not keyword_set(file) then file = 'collgrid8_separr.dat
restore,file
...
WHILE (flag ne 1) do begin
  ...
  if not keyword_set(savefile) then savefile='plotseparr8'

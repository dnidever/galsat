pro plotseparr7,file,psave=psave,color=color,post=post,$
...
if not keyword_set(file) then file = 'collgrid7_separr.dat
restore,file
...
;################################
;  To plot the minimum across
;  larger ranges use the less
;  than function
;  newsep = separr2 < separr3
;#################################

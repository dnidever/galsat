pro plotlss,file,dfile,over=over,twoplot=twoplot,save=save
...
print,'Minimum Separation Distance LMC-Sgr = ',stringize(min(sep),ndec=2),' kpc'
...
if keyword_set(save) then ps_open,'plotlss',/color
...
; point of closest approach
;oplot,arr(colind,0,0),r(colind),co=black,ps=2,symsize=1.7
;oplot,arr(colind,0,0),r(colind),co=yellow,ps=2,symsize=0.8
;oplot,arr(colind,1,0),r2(colind),co=black,ps=2,symsize=1.7
;oplot,arr(colind,1,0),r2(colind),co=yellow,ps=2,symsize=0.8
